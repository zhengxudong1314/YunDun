...
public class SW_NewMessageBean {
    ...
    public String get_tag_() {
        return _tag_;
    }

    public void set_tag_(String _tag_) {
        this._tag_ = _tag_;
    }
    ...
    public String getControl_suspectname() {
        return control_suspectname;
    }

    public void setControl_suspectname(String control_suspectname) {
        this.control_suspectname = control_suspectname;
    }
    ...
    public String getAppPusher() {
        return appPusher;
    }

    public void setAppPusher(String appPusher) {
