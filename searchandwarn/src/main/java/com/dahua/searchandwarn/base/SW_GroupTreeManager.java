...
public class SW_GroupTreeManager {

    private static volatile SW_GroupTreeManager mInstance;
    ...
    public static SW_GroupTreeManager getInstance(){
        if(mInstance == null){
            synchronized (SW_GroupTreeManager.class){
                if(mInstance == null){
                    mInstance = new SW_GroupTreeManager();
                }
            }
        }
        return mInstance;
