...
public class WheelView extends View {
    ...
    public static int TYPE_DEFAULT = 0; //线;
    public static int TYPE_RECTF = 1; //圆角空心矩形
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_wheelTextSize,textSize);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (drawType) {
            case 1:
                ...
                rectF.left = 0.0F;
                rectF.top = firstLineY;
                rectF.bottom = secondLineY;
                rectF.right = measuredWidth;
                canvas.drawRoundRect(rectF,60,60,paintIndicator);
                break;
            default:
                //中间两条横线
